...
export interface Operations {
  ...
  /**
   * The resulting block when this block is planted
   */
  ...
  /**
   * The resulting block when this item is planted
   */
  ...
  /**
   * Get the NBT tag of the given item.
   */
  ...
  /**
   * The plant type of the given item
   */
  ...
  /**
   * If the item stack has an NBT tag.
   */
