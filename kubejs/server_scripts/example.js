...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu
        ...
        .EUt(32768);
    event.recipes.gtceu
        .centrifuge("separate-8x")
        .itemInputs("8x gtceu:purple_drink")
        .itemOutputs("192x gtceu:naquadah_dust")
        .itemOutputs("48x gtceu:rutile_dust")
        .itemOutputs("192x gtceu:rock_salt_dust")
        .itemOutputs("480x kubejs:power_ingot")
        .itemOutputs("32x kubejs:new_sulfur_trioxide_token")
        .outputFluids(Fluid.of("gtceu:helium", 40000))
        .duration(19200)
        .circuit(2)
        .EUt(32768);
